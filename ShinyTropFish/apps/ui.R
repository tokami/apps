...
<h3 style="text-align:center;float:center;line-height:50px;"> - This app allows you to conduct a length-based stock assessment based on ELEFAN and YPR - </h3>
<hr style="clear:both;"/>'),
imageOutput("image"),
br(),
##tags$hr(),
