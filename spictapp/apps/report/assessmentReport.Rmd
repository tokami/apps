...
if(!is.null(params$rv$fit)){
    if(doc.type == "docx"){
        flextable(
            as.data.frame(round(sumspict.parest(params$rv$fit),3))
        )
    }else{
        kable(
...
if(!is.null(params$rv$fit)){
    if(doc.type == "docx"){
        flextable(
            as.data.frame(round(sumspict.srefpoints(params$rv$fit),3))
        )
    }else{
        kable(
...
if(!is.null(params$rv$fit)){
    if(doc.type == "docx"){
        flextable(
            as.data.frame(round(sumspict.drefpoints(params$rv$fit),3))
        )
    }else{
        kable(
...
if(!is.null(params$rv$fit)){
    if(doc.type == "docx"){
        flextable(
            as.data.frame(round(sumspict.states(params$rv$fit),3))
        )
    }else{
        kable(
...
if(!is.null(params$rv$fit)){
    if(doc.type == "docx"){
        flextable(
            as.data.frame(round(sumspict.predictions(params$rv$fit),3))
        )
    }else{
        kable(
...
if(!is.null(params$rv$fit)){
    if(doc.type == "docx"){
        flextable(
            as.data.frame(sumspict.diagnostics(params$rv$fit)),
...
if(!is.null(params$rv$sensi)){
    if(doc.type == "docx"){
        flextable(
            as.data.frame(sumspict.ini(params$rv$sensi[[1]]))
        )
    }else{
        kable(
            sumspict.ini(params$rv$sensi[[1]]),
              booktabs = TRUE,
...
if(!is.null(params$rv$sensi)){
    if(doc.type == "docx"){
        flextable(
            as.data.frame(sumspict.ini(params$rv$sensi[[2]]))
        )
    }else{
        kable(
            sumspict.ini(params$rv$sensi[[2]]),
            booktabs = TRUE,
...
if(!is.null(params$rv$sensi)){
    if(doc.type == "docx"){
        flextable(
            as.data.frame(sumspict.ini(params$rv$sensi[[3]]))
        )
    }else{
        kable(
            sumspict.ini(params$rv$sensi[[3]]),
            booktabs = TRUE,
...
if(!is.null(params$rv$mana)){
    if(doc.type == "docx"){
        flextable(
            as.data.frame(sumspict.manage(params$rv$mana))
        )
    }else{
        kable(
