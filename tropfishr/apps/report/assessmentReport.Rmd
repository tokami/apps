...
This report has been created automatically with the ShinyTropFish software. It provides some background to the different assessment methods and summaries the results of the length-based stock assessment based on the data set "`r strsplit(params$rv$filename,"Data: ")[[1]][2]`".
According to @Sparre1998b, ... 

Based on TropFishR version `r packageVersion("TropFishR")`.
