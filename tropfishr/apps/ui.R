...
<h3 style="text-align:center;float:center;line-height:50px;"> - This app allows you to conduct a length-based stock assessment of your own data without requiring any R knowledge - </h3> 
<hr style="clear:both;"/>'),
...
tabPanel("Reference levels", id = "refs",
         ...
         sidebarLayout(
             ...
             mainPanel(
                 ...
                 br(),
                 tags$h4("Fitted parameters:"),                                          
                 tableOutput("lbsprPars"),
                 br(),
                 plotOutput(outputId = "LBSPR1_plot",
                            width = "100%"),
                 br(),
                 plotOutput(outputId = "LBSPR2_plot",
                            width = "100%"),
                 br(),
                 plotOutput(outputId = "LBSPR3_plot",
                            width = "100%"),
                 br(),
                 plotOutput(outputId = "LBSPR4_plot",
                            width = "100%"),                                  
                 br()                  
             )
         )
...
tabPanel("Overview", id = "overview",
         ...
         ##               width = "80%", height = "auto",             
             ...
             mainPanel(
                 ...
                 tags$hr(style = "border-top: dashed 2px #3891BA;"),
                 br(),
                 tableOutput("lbsprPars_ov"),
                 br(),
                 plotOutput(outputId = "LBSPR1_plot_ov",
                            width = "100%"),
                 br(),
                 plotOutput(outputId = "LBSPR2_plot_ov",
                            width = "100%"),
                 br(),
                 plotOutput(outputId = "LBSPR3_plot_ov",
                            width = "100%"),
                 br(),
                 plotOutput(outputId = "LBSPR4_plot_ov",
                            width = "100%"),                                  
                 br(),                 
                 br()                                  
             )
